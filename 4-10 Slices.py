...
print(f"the first 3 items on the list are {guests[0:3]}")
print(f"the middle 3 items on the list are {guests[2:5]}")
print(f"the last 3 items on the list are {guests[3:]}")